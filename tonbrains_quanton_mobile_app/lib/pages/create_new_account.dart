...
class CreateNewAccountScreen extends StatefulWidget {
  ...
  CreateNewAccountScreen({Key key, this.mode}) : super(key: key);
...
class _CreateNewAccountScreenState extends State<CreateNewAccountScreen>
  ...
  Widget build(BuildContext context) {
    ...
    listViews.add(appTitleGoodTimes("Create New Account"));
    ...
    listViews.add(Padding(
      ...
      child: infoMesssageAlignLeft("1. Please enter valid email"),
    ));
    listViews.add(SizedBox(height: 20));

    listViews.add(Padding(
      padding: const EdgeInsets.only(left: 20),
      child: infoMesssageAlignLeft("2. Check your inbox for instructions"),
    ));
    listViews.add(SizedBox(height: 35));
    listViews.add(
      TextFormField(
